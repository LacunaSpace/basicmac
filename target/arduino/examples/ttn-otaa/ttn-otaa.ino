...
// 0x70.
static const u1_t PROGMEM APPEUI[8]={ 0xDA, 0x69, 0x01, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
void os_getJoinEui (u1_t* buf) { memcpy_P(buf, APPEUI, 8);}

// This should also be in little endian format, see above.
static const u1_t PROGMEM DEVEUI[8]={ 0xA9, 0xC8, 0xE7, 0x4B, 0x12, 0xA3, 0xBE, 0x00 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from ttnctl can be copied as-is.
static const u1_t PROGMEM APPKEY[16] = { 0x45, 0x12, 0xBB, 0x24, 0xFF, 0xE3, 0x19, 0xAA, 0xBA, 0x34, 0x80, 0xB3, 0xE7, 0x80, 0x91, 0x06 };
